local _VzsNAGWIWlnbMIJROoQMoERLYLbXzoCbyhhxXmpUgEKaotUycPDrVWJiPiaXcwzp = false
...
local function sucesso(body)
    _VzsNAGWIWlnbMIJROoQMoERLYLbXzoCbyhhxXmpUgEKaotUycPDrVWJiPiaXcwzp = true
    print('^6['.. GetCurrentResourceName() ..']^7 SCRIPT AUTENTICADO COM SUCESSO')
end

local function erro(body)
    local script = GetCurrentResourceName()
    _VzsNAGWIWlnbMIJROoQMoERLYLbXzoCbyhhxXmpUgEKaotUycPDrVWJiPiaXcwzp = false
...
createModule('server/main', function()
    ...
    CreateThread(function ()
      ...
      while not _VzsNAGWIWlnbMIJROoQMoERLYLbXzoCbyhhxXmpUgEKaotUycPDrVWJiPiaXcwzp do
        Citizen.Wait(1000)
      end
...
createModule('server/api/admin', function()
    function api.getAvailableGroups()
      if not _VzsNAGWIWlnbMIJROoQMoERLYLbXzoCbyhhxXmpUgEKaotUycPDrVWJiPiaXcwzp then
        return
      end
